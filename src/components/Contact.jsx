...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-white">
      <Element name="contactEl">
        <SouthernCross className="top-14 z-0 w-80 md:left-48" opacity={0.25} />
            ...
            <div className="mt-12">
              {!requestSent ? (
                ...
                <div className="my-60 text-sm">
                  ...
                  your submission carefully. Please note that Daniel in the
                  office will be in touch with you shortly to discuss your
                  submission further. In the meantime, if you have any further
                  questions or need to update your submission, please don&apos;t
                  hesitate to contact us. Thank you again for considering us for
                  your employment needs. We look forward to potentially working
